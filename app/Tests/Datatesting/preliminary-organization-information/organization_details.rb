class OrganizationDetails
  ...
  def self.organization_information(display, org_ids)
    ...
    org_ids.each do |org_id|
      ...
      result_for_org = { org_id => result[:organization_information][org_id] } #, :outcome => outcome_org_key_users_exist(result) }
  ...
  def self.admins_with_organization_access(display, org_ids)
    ...
    org_ids.each do |org_id|
      ...
      result_for_org = { org_id => result[:admins_with_organization_access][org_id] } #, :outcome => outcome_get_admins_with_organization_access(result) }
      test_name = result.keys.first.to_s
  ...
  def self.doubled_groups?(display, org_ids)
    ...
    org_ids.each do |org_id|
      ...
      result_for_org = { org_id => result[:doubled_groups?][org_id] } #, :outcome => outcome_get_doubled_groups(result) }
      test_name = result.keys.first.to_s
  ...
  def self.duplicate_course_records?(display, org_ids)
    ...
    org_ids.each do |org_id|
      ...
      result_for_org = { org_id => result[:duplicate_course_records?][org_id] } #, :outcome => outcome_get_duplicated_course_records(result) }
      test_name = result.keys.first.to_s
  ...
  def self.all_org_key_users_exist?(display, org_ids)
    ...
    org_ids.each do |org_id|
      ...
      result_for_org = { org_id => result[:all_org_key_users_exist?][org_id] } #, :outcome => outcome_get_org_key_users_exist(result) }
      test_name = result.keys.first.to_s
  ...
  def self.organization_key_counts(display, org_ids)
    ...
    org_ids.each do |org_id|
      ...
      result_for_org = { org_id => result[:organization_key_counts][org_id] } #, :outcome => outcome_get_organization_key_counts(result) }
      test_name = result.keys.first.to_s
