class DatabaseTestRunner
  ...
  def complete_course_for_user(user_id, enrollment)
    ...
    # 3570093 (test20140224114419) eid => 2770139
    # 3570098 (test20140304151124) eid => 2770142
    user = { :id => user_id, :enrollment_id => enrollment }
